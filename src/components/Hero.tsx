  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 h-full flex flex-col pt-[180px] md:pt-[160px]">
          <div className="max-w-3xl">
            ...
            <motion.p
              ...
              className="text-white/90 text-base md:text-lg mb-10 max-w-xl leading-relaxed"
            >
