...
export default function NotFound() {
  return (
    <>
      <Navbar />
      <main>
        <div className="min-h-[60vh] bg-white flex items-center justify-center px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-wrap gap-4 justify-center text-sm items-center">
                ...
                <span className="text-gray-300">•</span>
                <ConsultationButton className="text-[#E85D3F] hover:underline bg-transparent p-0">
                  Contact
                </ConsultationButton>
              </div>
            </div>
